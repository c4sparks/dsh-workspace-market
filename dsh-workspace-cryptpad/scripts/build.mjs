 ...
 *
 * - client：cjs + __ModuleLoader__.load 格式（toolkit 的 build-client.mjs 模式，页面裸 import react）。
 * - host：esm / node（cryptpad 只在运行时经 createRequire 解析，不在构建期 import，无需 external）。
 *
...
const CLIENT_ID = "dsh-workspace-cryptpad";
const banner = [
...
// host：esm / node（node 内置模块自动 external）
await esbuild.build({
