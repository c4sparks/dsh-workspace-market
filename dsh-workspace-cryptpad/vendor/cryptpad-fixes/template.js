...
define([
    ...
    // NOTE(dsh-workspace-cryptpad sidecar, modified 2026-08-30): the CryptPad UI is framed by the DSH
    // desktop shell, so embedding must be allowed. The server-side CSP already
    // gates framing via `frame-ancestors` (ENABLE_EMBEDDING decree).
